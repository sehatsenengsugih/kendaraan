    ...
    <x-slot name="header">
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-sm text-bgray-600 dark:text-bgray-50">{{ $paroki->nama }}</p>
            </div>
        </div>
    </x-slot>

    <div class="rounded-lg bg-white p-6 dark:bg-darkblack-600">
        <form method="POST" action="{{ route('paroki.update', $paroki) }}">
            @csrf
            @method('PUT')
            ...
            <div class="grid gap-6 md:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="text" name="kota" id="kota" value="{{ old('kota', $paroki->kota) }}"
