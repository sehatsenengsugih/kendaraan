<x-app-layout>
    ...
    <div class="rounded-lg bg-white p-6 dark:bg-darkblack-600">
        <form method="POST" action="{{ route('paroki.store') }}" x-data="{ statusParoki: '{{ old('status_paroki_id', 1) }}' }">
            @csrf
                ...
                <div class="grid gap-6 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <select name="status_paroki_id" id="status_paroki_id" required x-model="statusParoki"
                            ...
                            <option value="2">Quasi Paroki</option>
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_gereja" id="nama_gereja" value="{{ old('nama_gereja') }}"
