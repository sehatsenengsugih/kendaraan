            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <div class="flex gap-6">
                        <label class="flex cursor-pointer items-center gap-3 rounded-lg border border-bgray-200 px-4 py-3 transition-all hover:border-accent-300 dark:border-darkblack-400 @if(old('jenis', $merk->jenis) === 'mobil') border-accent-300 bg-accent-50 @endif">
                        ...
                        <label class="flex cursor-pointer items-center gap-3 rounded-lg border border-bgray-200 px-4 py-3 transition-all hover:border-accent-300 dark:border-darkblack-400 @if(old('jenis', $merk->jenis) === 'motor') border-accent-300 bg-accent-50 @endif">
