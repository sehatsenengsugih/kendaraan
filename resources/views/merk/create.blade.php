<x-app-layout>
    <x-slot name="title">Tambah Merk</x-slot>
    ...
    <x-slot name="header">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h2 class="text-2xl font-bold text-bgray-900 dark:text-white">Tambah Merk</h2>
                <p class="text-sm text-bgray-600 dark:text-bgray-50">Tambah merk kendaraan baru</p>
            </div>
        </div>
    </x-slot>
