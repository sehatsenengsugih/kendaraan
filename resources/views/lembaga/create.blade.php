<x-app-layout>
    <x-slot name="title">Tambah Lembaga</x-slot>
    ...
    <x-slot name="header">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h2 class="text-2xl font-bold text-bgray-900 dark:text-white">Tambah Lembaga</h2>
                <p class="text-sm text-bgray-600 dark:text-bgray-50">Tambah data lembaga baru</p>
            </div>
        </div>
    </x-slot>
        ...
        <form method="POST" action="{{ route('lembaga.store') }}">
            ...
            <div class="grid gap-6 md:grid-cols-2">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="alamat" id="alamat" rows="3"
                        ...
                        placeholder="Masukkan alamat lengkap lembaga">{{ old('alamat') }}</textarea>
                    @error('alamat')
                        <p class="mt-1 text-sm text-error-300">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="mt-6 flex items-center gap-4">
                <button type="submit"
                    ...
                    <i class="fa fa-save mr-2"></i> Simpan Lembaga
                </button>
                <a href="{{ route('lembaga.index') }}"
