                ...
                <tbody>
                    @forelse($lembaga as $l)
                        <tr class="border-b border-bgray-200 last:border-0 dark:border-darkblack-400">
                            <td class="px-6 py-4">
                                <a href="{{ route('lembaga.show', $l) }}" class="font-medium text-bgray-900 hover:text-success-300 dark:text-white">
                                    {{ $l->nama }}
                                </a>
                                @if($l->alamat)
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-6 py-12 text-center text-bgray-500 dark:text-bgray-50">
                                ...
                                <a href="{{ route('lembaga.create') }}" class="mt-2 inline-block text-success-300 hover:underline">
