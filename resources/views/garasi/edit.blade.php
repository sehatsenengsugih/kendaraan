<x-app-layout>
    <x-slot name="title">Edit Garasi</x-slot>
    ...
    <x-slot name="header">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h2 class="text-2xl font-bold text-bgray-900 dark:text-white">Edit Garasi</h2>
                <p class="text-sm text-bgray-600 dark:text-bgray-50">{{ $garasi->nama }}</p>
            </div>
        </div>
    </x-slot>

    <div class="rounded-lg bg-white p-6 dark:bg-darkblack-600">
        <form method="POST" action="{{ route('garasi.update', $garasi) }}">
            @csrf
            @method('PUT')
            ...
            <div class="grid gap-6 md:grid-cols-2">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="nama" id="nama" value="{{ old('nama', $garasi->nama) }}" required
                ...
                <div>
                    ...
                    <select name="kevikepan_id" id="kevikepan_id" required
                        ...
                        @foreach($kevikepan as $kev)
                            <option value="{{ $kev->id }}" {{ old('kevikepan_id', $garasi->kevikepan_id) == $kev->id ? 'selected' : '' }}>
                                {{ $kev->nama }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <input type="text" name="kota" id="kota" value="{{ old('kota', $garasi->kota) }}" required
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="alamat" id="alamat" rows="3" required
                        ...
                        placeholder="Masukkan alamat lengkap garasi">{{ old('alamat', $garasi->alamat) }}</textarea>
                    @error('alamat')
                        <p class="mt-1 text-sm text-error-300">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="kode_pos" id="kode_pos" value="{{ old('kode_pos', $garasi->kode_pos) }}"
                ...
                <div>
                    ...
                    <input type="text" name="pic_name" id="pic_name" value="{{ old('pic_name', $garasi->pic_name) }}"
                ...
                <div>
                    ...
                    <input type="text" name="pic_phone" id="pic_phone" value="{{ old('pic_phone', $garasi->pic_phone) }}"
