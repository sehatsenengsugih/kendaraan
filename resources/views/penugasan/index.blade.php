        ...
        <div class="rounded-lg bg-white p-4 dark:bg-darkblack-600">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-accent-400">{{ $stats['aktif'] }}</p>
                </div>
                <div class="rounded-full bg-accent-50 p-3">
                    <i class="fa fa-play-circle text-accent-400"></i>
                </div>
            </div>
        </div>
        <div class="rounded-lg bg-white p-4 dark:bg-darkblack-600">
                    ...
                    @forelse($penugasan as $p)
                        <tr class="border-b border-bgray-200 last:border-0 dark:border-darkblack-400">
                            ...
                            <td class="px-6 py-4">
                                ...
                                @elseif($p->isAktif())
                                    <p class="text-xs text-accent-400">{{ $p->durasi }} hari berjalan</p>
                                @endif
                            </td>
